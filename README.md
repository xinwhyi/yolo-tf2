...
```sh
git clone https://github.com/unsignedrant/yolo-tf2
```
...
[labelpix](https://github.com/unsignedrant/labelpix) to visualize results with
bounding boxes
...
unsignedrant@outlook.com

Project link: https://github.com/unsignedrant/yolo-tf2
